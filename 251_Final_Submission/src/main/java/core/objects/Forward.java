...
public class Forward extends Player{
    public Forward(String name, String teamName, char position, Float points, Float assists, Float rebounds, int uniqueStat1, int uniqueStat2){
    ...
    public String toString() {
        ...
        return getName() +" "+ getTeamName() +" "+ getPosition() +"\n\n====Stats====\n"+ "PPG: " +getPoints() +"\tAPG: "+ getAssists() +"\tRPG: "+ getRebounds() +"\n\n====Unique Forward Ratings====\n" + "Defense Ability: " +getUniqueStat1() +"\tMidRange Ability: "+getUniqueStat2();
    }
}
